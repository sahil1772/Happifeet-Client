...
class DeviceDimensions {
  ...
  static double getBottomSheetHeight(BuildContext context,double HEADER_HEIGHT) {
  ...
  static double getBottomSheetMargin(BuildContext context,double HEADER_HEIGHT) {
