...
class StatusDetailPage extends StatefulWidget{
  ...
  gotoStatusFilterPage(BuildContext context){
    Navigator.push(context, MaterialPageRoute(builder: (_) => StatusDetailPage() ));
  }
...
class _StatusDetailPageState extends State<StatusDetailPage>{
  ...
  getFeedbackStatusDetails() async{
    var response = await ApiFactory().getFeedbackStatusService().getFeedbackStatusDetails("feedback_view_report", widget.report_id!);
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Row(
              //   children: [
              //     SvgPicture.asset("assets/images/comments/location.svg",width: 25,height: 25),
              //     SizedBox(width: 10,),
              //     Text("Tallahassee, FL 32309, USA"),
              //   ],
              // ),
              // SizedBox(height: 15,),
              // Row(
              //   children: [
              //     SvgPicture.asset("assets/images/comments/user.svg",width: 25,height: 25),
              //     SizedBox(width: 10,),
              //     Text("John Wikk"),
              //   ],
              // ),
              ...
              // Row(
              //   children: [
              //     SvgPicture.asset("assets/images/comments/email.svg",width: 25,height: 25,),
              //     SizedBox(width: 10,),
              ...
              Row(
                children: [
                  OutlinedButton(
                    ...
                    child: Text("English",style: TextStyle(color: isSelected ? Resources.colors.buttonColorlight : Colors.grey),),
                  ),
                  ...
                  OutlinedButton(
                    ...
                    child: Text("Español",style: TextStyle(color:isSelected ?  Colors.grey : Resources.colors.buttonColorlight ),),
                  )
                ],
              ),
              ...
              Row(
                children: [
                  OutlinedButton(
                    ...
                    child: Text("Complete",style: TextStyle(color: isSelected ? Resources.colors.buttonColorlight : Colors.grey),),
                  ),
                  ...
                  OutlinedButton(
                    ...
                    child: Text("Pending",style: TextStyle(color:isSelected ?  Colors.grey : Resources.colors.buttonColorlight ),),
                  )
                ],
              ),
              ...
              /** Assigned To **/
              SizedBox(height: 24,),
              const Text("Assigned To",style: TextStyle(
                  fontSize: 18,
                  fontWeight: FontWeight.w500,
                  color: Colors.black)),
              SizedBox(height: 8,),
                  ...
                  child: Row(
                    children: [
                      OutlinedButton(
                        onPressed: (){
                          if (imageFile!
                            ...
                            ScaffoldMessenger.of(
                                ...
                                content:
                                Text('Max 3 images can be uploaded')));
                          }
                        ...
                        child: Text("Choose File",style: TextStyle(color:  Resources.colors.buttonColorlight ),),
                      ),
                      SizedBox(width: 20,),
                      Text("File")
                    ],
