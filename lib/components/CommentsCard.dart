           ...
           Padding(
             ...
             child: Column(
               ...
               children: [
                 ...
                 Row(
                   children: [
                     SvgPicture.asset("assets/images/comments/profile.svg"),
                     SizedBox(width: 10,),
                     Text("John Wikk",style: TextStyle(fontSize: 14,fontWeight: FontWeight.w500,color: Resources.colors.hfText)),
                 ...
                 Row(
                   children: [
                     SvgPicture.asset("assets/images/comments/email.svg"),
                     SizedBox(width: 10,),
                     Text("tester7701@gmail.com",style: TextStyle(fontSize: 14,fontWeight: FontWeight.w500,color: Resources.colors.hfText)),
             ...
             child: Row(
               ...
               children: [
                 Column(
                   crossAxisAlignment: CrossAxisAlignment.start,
                   children: [
                     Text("Share Anonymously",style: TextStyle(fontSize: 14,fontWeight: FontWeight.w500,color: Resources.colors.hfText),),
                     Text("Yes",style: TextStyle(fontSize: 14,fontWeight: FontWeight.w400,color: Resources.colors.hfText)),
                     SizedBox(height: 15,),
                     Text("Recommend",style: TextStyle(fontSize: 14,fontWeight: FontWeight.w500,color: Resources.colors.hfText)),
                     Text("HappiLy",style: TextStyle(fontSize: 14,fontWeight: FontWeight.w400,color: Resources.colors.hfText)),
                     SizedBox(height: 15,),
                     Text("Assigned By",style: TextStyle(fontSize: 14,fontWeight: FontWeight.w500,color: Resources.colors.hfText)),
                     Text("User 1",style: TextStyle(fontSize: 14,fontWeight: FontWeight.w400,color: Resources.colors.hfText)),
                   ],
                 ),
                 VerticalDivider(
                   color: Colors.grey.shade200,
                 ...
                 Column(
                   crossAxisAlignment: CrossAxisAlignment.start,
                   children: [
                     Text("Rating",style: TextStyle(fontSize: 14,fontWeight: FontWeight.w500,color: Resources.colors.hfText)),
                     RatingBar.builder(
                     ...
                     SizedBox(height: 15,),
                     Text("Date",style: TextStyle(fontSize: 14,fontWeight: FontWeight.w500,color: Resources.colors.hfText)),
                     Text("09 Jan, 2023",style: TextStyle(fontSize: 14,fontWeight: FontWeight.w400,color: Resources.colors.hfText)),
                     SizedBox(height: 15,),
                     Text("Assigned By",style: TextStyle(fontSize: 14,fontWeight: FontWeight.w500,color: Resources.colors.hfText)),
                     Text("User 2",style: TextStyle(fontSize: 14,fontWeight: FontWeight.w400,color: Resources.colors.hfText)),
                   ],
                 ),
               ],
             ),
